...
public class Web2TestContainer extends TestContainer {

    public Web2TestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/web2/app.properties",
    ...
    public static class Common extends Web2TestContainer {

        public static final Web2TestContainer.Common INSTANCE = new Web2TestContainer.Common();
